...
const config: Config = {
  ...
  tagline: 'Empowering the next generation of AI and IT professionals ',
  ...
  url: 'https://Mohammed-Jemal.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/ethio-ai-academy/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'Mohammed-Jemal', // Usually your GitHub org/user name.
